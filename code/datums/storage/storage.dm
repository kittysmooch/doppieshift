...
/datum/storage/proc/open_storage(mob/living/to_show, can_reach_target = parent) // DOPPLER EDIT ADDITION, old code: /datum/storage/proc/open_storage(mob/living/to_show)
