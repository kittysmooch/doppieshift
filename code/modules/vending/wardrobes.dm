...
/obj/machinery/vending/wardrobe/sec_wardrobe
	...
	products = list(
		...
		///obj/item/clothing/gloves/color/black/security/blu = 3,	// DOPPLER EDIT REMOVAL - dummied out for the security resprite
...
/obj/machinery/vending/wardrobe/cargo_wardrobe
	...
	premium = list(
		...
		// /obj/item/clothing/under/rank/cargo/miner = 3, // DOPPLER EDIT, MOVED TO REGULAR CATEGORY
		// /obj/item/clothing/under/rank/cargo/miner/lavaland = 3, // DOPPLER EDIT, MOVED TO REGULAR CATEGORY
