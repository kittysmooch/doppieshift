...
/datum/crewmonitor
	...
	var/list/jobs = list(
		...
		JOB_CHIEF_GUARD = 10, // DOPPLER EDIT ADDITION - Security Lore Rework
		JOB_WARDEN = 11,
		JOB_DISPATCHER = 11, // DOPPLER EDIT ADDITION - Security Lore Rework
		JOB_SECURITY_OFFICER = 12,
		JOB_SECURITY_GUARD = 12, // DOPPLER EDIT ADDITION - Security Lore Rework
		JOB_SECURITY_OFFICER_MEDICAL = 13,
		JOB_SECURITY_GUARD_MEDICAL = 13, // DOPPLER EDIT ADDITION - Security Lore Rework
		JOB_SECURITY_OFFICER_ENGINEERING = 14,
		JOB_SECURITY_GUARD_ENGINEERING = 14, // DOPPLER EDIT ADDITION - Security Lore Rework
		JOB_SECURITY_OFFICER_SCIENCE = 15,
		JOB_SECURITY_GUARD_SCIENCE = 15, // DOPPLER EDIT ADDITION - Security Lore Rework
		JOB_SECURITY_OFFICER_SUPPLY = 16,
		JOB_SECURITY_GUARD_SUPPLY = 16, // DOPPLER EDIT ADDITION - Security Lore Rework
		JOB_DETECTIVE = 17,
		// 20-29: Medbay
