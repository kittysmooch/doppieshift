...
/obj/machinery/computer/records/security
	...
	req_one_access = list(ACCESS_SECURITY, ACCESS_HOP, ACCESS_LAWYER) // DOPPLER EDIT CHANGE - Security Lore Rework - Original: req_one_access = list(ACCESS_SECURITY, ACCESS_HOP)
