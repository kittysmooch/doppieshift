//reskins of pdas ฅ^•ﻌ•^ฅ

/obj/item/modular_computer/pda/cat
	name = "neko PDA"
	...
	icon_state = "/obj/item/modular_computer/pda/cat"
...
/obj/item/modular_computer/pda/rugged
	name = "rugged PDA"
	desc = "The extra thick shell, rubberized bumpers, and convenient carrying handle make this PDA quite \
...
/obj/item/modular_computer/pda/slimline
	name = "slimeline PDA"
	desc = "As the hardware component that makeup this venerable piece of information technology have plateaued in \
