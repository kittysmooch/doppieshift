// Plastic flaps made of wall panels, for keeping air in
// Note that plastic flaps will melt super fast is exposed to any adverse conditions

/obj/structure/plasticflaps/colony
