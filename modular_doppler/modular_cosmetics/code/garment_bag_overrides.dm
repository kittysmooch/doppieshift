...
/obj/item/storage/bag/garment/hos/PopulateContents()
	. = ..()
	new /obj/item/clothing/under/rank/security/doppler/head_of_security(src)
	new /obj/item/clothing/under/rank/security/doppler/head_of_security/skirt(src)
	new /obj/item/clothing/suit/armor/hos/trenchcoat(src)
	new /obj/item/clothing/suit/jacket/officer/doppler/ps_d1(src)
	new /obj/item/clothing/neck/doppler_mantle/security(src)
	new /obj/item/clothing/head/hats/hos/beret_doppler(src)
...
/obj/item/storage/bag/garment/warden/PopulateContents()
	...
	new /obj/item/clothing/under/rank/security/doppler/warden/skirt(src)
